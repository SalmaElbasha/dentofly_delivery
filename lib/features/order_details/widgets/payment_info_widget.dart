...
class PaymentInfoWidget extends StatelessWidget {
  ...
  const PaymentInfoWidget({Key? key, this.itemsPrice, this.discount, this.tax, this.subTotal, this.deliveryCharge, this.totalPrice, this.isPaid = false, this.serviceFee}) : super(key: key);
    ...
    return Container(
        ...
        child: Column(children: [
          ...
          Column(children: [
            ...
            OrderItemInfoWidget(title: 'service_fee',info: serviceFee.toString(), isPrice: true),
